...
class MtcnnDetector(object):
    ...
    def generate_bounding_box(self, map, reg, scale, threshold):
        ...
        # leftmouth_dx, leftmouth_dy, rightmouth_dx, rightmouth_dy = [landmarks[0, t_index[0],
        #                                                                       t_index[1], i] for i in range(10)]
        # landmarks = np.array([lefteye_dx, lefteye_dy, righteye_dx, righteye_dy,
        #                       nose_dx, nose_dy, leftmouth_dx, leftmouth_dy, rightmouth_dx, rightmouth_dy])
